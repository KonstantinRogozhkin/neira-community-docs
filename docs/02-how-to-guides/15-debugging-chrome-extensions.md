...
### 🔧 [Инструменты отладки](/02-how-to-guides/chrome-extensions-debug/01-debug-tools)
...
### 🚨 [Диагностика проблем установки](/02-how-to-guides/chrome-extensions-debug/02-installation-issues)
...
1. **Расширение не устанавливается** → [Диагностика установки](/02-how-to-guides/chrome-extensions-debug/02-installation-issues)
...
- [Chrome Extensions Reference](/04-reference/02-chrome-extensions)
- [Безопасность расширений](/05-contributing/10-extension-security-guidelines)
