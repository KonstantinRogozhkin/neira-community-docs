...
**Связи:** [Системный обзор](/core-concepts/architecture-patterns/system-overview), [Архитектура менеджеров](/core-concepts/architecture-patterns/manager-architecture).
